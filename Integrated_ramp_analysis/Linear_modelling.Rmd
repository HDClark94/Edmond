...
process_data <- function(space_binned_data, classification_df, TT, track_region){
  ...
  for (session_id in session_ids) {
    ...
    session_data <- subset(space_binned_data, session_id == session_id)
    ...
    for (id in cluster_ids) {
      ...
      cluster_classification_df <- data.frame(cluster_id=c(id), session_id=c(session_id), trial_type=c(TT), track_region=c(track_region),
...
space_binned_data = read.csv("space_binned_concatenated_spike_data.csv", header = TRUE)
