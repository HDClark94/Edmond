...
def run_curation_analysis(sorted_together_vr_dir_path, sorted_together_of_dir_path, sorted_apart_vr_dir_path,
                  save_path, figs_path=None, add_of_and_save=False, cohort_mouse=None):
    ...
    for i in range(len(sorted_together_vr_list)):
        try:
            ...
            print("Starting curration analysis for between ", get_id(sorted_together_vr), " and ", get_id(sorted_apart_vr))
    ...
    plot_curation_stats(concat_apart, concat_together, figs_path, cohort_mouse)
...
def main():
    ...
    run_curation_analysis(sorted_together_vr_dir_path, sorted_together_of_dir_path, sorted_apart_vr_dir_path, save_path,
