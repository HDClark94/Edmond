...
def run_agreement(sorted_together_vr_dir_path, sorted_together_of_dir_path, sorted_apart_vr_dir_path,
    ...
    for i in range(len(sorted_together_vr_list)):
        try:
            ...
            print("Starting sorting comparison between ", get_id(sorted_together_vr), " and ", get_id(sorted_apart_vr))
            ...
            agreement, agreement_stats = sorting_comparison.correlation(sorted_together_path=sorted_together_vr + dataframe_subpath,
                                                                        ...
                                                                        plot=True,
                                                                        figs_path=figs_path,
                                                                        agreement_threshold=30,
                                                                        autocorr_windowsize=4)
    ...
    if add_of_and_save:
        concat_agreement.to_pickle(save_path+"_sorting_stats.pkl")

    plot_agreement_stats(concat_agreement_stats, figs_path, cohort_mouse)
