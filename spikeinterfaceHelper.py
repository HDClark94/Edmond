...
def sorter2dataframe(sorter, session_id, start_frame=None, end_frame=None):
    ...
    for i in sorter.get_unit_ids():
        ...
        propertyDict['spike_train'] = sorter.get_unit_spike_train(i, start_frame=start_frame, end_frame=end_frame)
