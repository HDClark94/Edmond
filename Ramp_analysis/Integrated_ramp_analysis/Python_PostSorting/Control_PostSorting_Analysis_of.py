import Edmond.Ramp_analysis.Integrated_ramp_analysis.Python_PostSorting.Calculate_SpikeHalfWidth
...
def main():
    ...
    spike_data = Edmond.Ramp_analysis.Integrated_ramp_analysis.Python_PostSorting.Calculate_SpikeHalfWidth.calculate_spike_width(spike_data, prm)
